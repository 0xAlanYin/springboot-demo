package org.example.web3j.controller;
...
public class BlockChainInfoController {
  ...
  public String doGetAll(@RequestParam(value = "blockNumber") Long blockNumber) throws Exception {
    DefaultBlockParameterNumber defaultBlockParameterNumber =
        new DefaultBlockParameterNumber(blockNumber);
    EthBlock ethBlock =
        web3j.ethGetBlockByNumber(defaultBlockParameterNumber, true).sendAsync().get();
  ...
  public String doGetTransactionInfoByHash(@RequestParam(value = "txHash") String txHash)
      throws Exception {
